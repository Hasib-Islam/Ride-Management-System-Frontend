    ...
    <footer className="bg-background border-t">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-muted-foreground">
              Your reliable ride booking platform. Book rides instantly with our
              easy-to-use app.
            </p>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <Button
                    ...
                    asChild
                  >
                    <Link to="/rides">Ride Booking</Link>
                  </Button>
                </li>
                <li>
                  <Button
                ...
                <li>
                  <Button
                    ...
                    asChild
                  >
                    <Link to="/business-rides">Business Rides</Link>
                  </Button>
                </li>
                <li>
                  <Button
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li>
                  <Button
                    ...
                    asChild
                  >
                    <Link to="/support">Live Chat</Link>
                  </Button>
                </li>
              </ul>
            </div>
        ...
        <p className="mt-8 text-xs text-muted-foreground">
          &copy; {new Date().getFullYear()} Ride App. All rights reserved.
        </p>
      </div>
    </footer>
  );
